...
public class BabyPopWindow implements OnDismissListener, OnClickListener {
	...
	public Bean_ListView_ware bean_listView_ware = new Bean_ListView_ware();



	public  void Set_Bean(Bean_ListView_ware bean_listView_ware){
		this.bean_listView_ware.set_Bean_ListView_ware(bean_listView_ware);
		System.out.println("zzz"+this.bean_listView_ware.toString());
	}


	public  Bean_ListView_ware Get_Bean(){
		System.out.println("aaa"+this.bean_listView_ware.toString());
		return this.bean_listView_ware;
	}
...
//		String Get_price=intent.getStringExtra("price");
//		String Get_Salenum= intent.getStringExtra("get_Salenum");
//		String Get_adress = intent.getStringExtra("adress");
		...
		System.out.println("qqqqq不加bean"+this.bean_listView_ware.toString());
//		pop_choice_16g.setText(Get_price());
	...
	public BabyPopWindow(Context context, Bean_ListView_ware bean_listView_ware) {
...
//		String Get_adress = intent.getStringExtra("adress");
		...
		pop_ok=(TextView) view.findViewById(R.id.pop_ok);
		pop_del=(ImageView) view.findViewById(R.id.pop_del);
		System.out.println("qqqqq+bean"+this.bean_listView_ware.toString());
		System.out.println("qqqqq+bean2"+Get_Bean().toString());
		//title = Get_Bean().toString();
//		pop_choice_16g.setText(Get_price());
		...
		switch (v.getId()) {
			...
			case R.id.pop_ok:
				...
				if (str_color.equals("")) {
					...
					//allHashMap.put("name",)
					allHashMap.put("name",Get_Bean().getName());
	...
	private void setSaveData(){
		...
		System.out.println("保存购物车" + this.bean_listView_ware.toString());
