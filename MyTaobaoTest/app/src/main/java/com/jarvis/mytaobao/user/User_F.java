...
public class User_F extends Fragment implements OnClickListener {
	...
	private RelativeLayout rly_user_home;
	...
	private void initView(View view){
		...
		rly_user_home=(RelativeLayout)view.findViewById(R.id.user_rly_home);
		login_user = (Button)view.findViewById(R.id.login_user);
		...
		rly_user_home.setOnClickListener(this);
	...
	public void onClick(View arg0) {
		switch (arg0.getId()) {
			...
			case R.id.user_rly_home://进入我的主页
